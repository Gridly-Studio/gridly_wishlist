...
if (! class_exists('GridlyWishlist_AJAX')) {

	class GridlyWishlist_AJAX
	{
		public function __construct()
		{
			add_action('wp_ajax_update_gridlywishlist', array($this, 'ajax_update_gridlywishlist_callback'));
			add_action('wp_ajax_nopriv_update_gridlywishlist', array($this, 'ajax_update_gridlywishlist_callback'));
			add_action('wp_ajax_gridlywishlist_bulk_remove', array($this, 'ajax_gridlywishlist_bulk_remove_callback'));
			add_action('wp_ajax_nopriv_gridlywishlist_bulk_remove', array($this, 'ajax_gridlywishlist_bulk_remove_callback'));
			add_action('wp_ajax_gridlywishlist_collection_create', array($this, 'ajax_gridlywishlist_collection_create'));
			add_action('wp_ajax_gridlywishlist_collection_update', array($this, 'ajax_gridlywishlist_collection_update'));
			add_action('wp_ajax_gridlywishlist_collection_delete', array($this, 'ajax_gridlywishlist_collection_delete'));
			add_action('wp_ajax_gridlywishlist_collection_move_items', array($this, 'ajax_gridlywishlist_collection_move_items'));
		}

		public function ajax_update_gridlywishlist_callback()
		{
		...
		public function ajax_gridlywishlist_bulk_remove_callback()
		{
			check_ajax_referer('gridlywishlist_toggle', 'nonce');
		...
		public function ajax_gridlywishlist_collection_create()
		{
			check_ajax_referer('gridlywishlist_toggle', 'nonce');
		...
		public function ajax_gridlywishlist_collection_update()
		{
			check_ajax_referer('gridlywishlist_toggle', 'nonce');
		...
		public function ajax_gridlywishlist_collection_delete()
		{
			check_ajax_referer('gridlywishlist_toggle', 'nonce');
			...
			$result = gridlywishlist_delete_collection($user_id, $collection_id);
			...
			wp_send_json_success(array(
				'message' => __('Collection deleted successfully.', 'gridlywishlist'),
				'collections' => gridlywishlist_prepare_collections_response($user_id),
			));
		}

		public function ajax_gridlywishlist_collection_move_items()
		{
			check_ajax_referer('gridlywishlist_toggle', 'nonce');
			...
			$result = gridlywishlist_move_items_to_collection($user_id, $product_ids, $target_collection_id);
